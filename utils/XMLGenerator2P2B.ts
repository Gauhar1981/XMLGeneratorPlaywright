...
export function generateClaimsXml2P2B(data: any, ID: string): string {
  ...
  const benefitXml = (data.Benefits || []).map((benefits: any) => `
  <Benefits> 
    <Status>${benefits.Status ?? ""}</Status>
    <DN0085>${benefits.DN0085 ?? ""}</DN0085>
    <DN0086>${benefits.DN0086 ?? ""}</DN0086>
    <DN0087>${benefits.DN0087 ?? ""}</DN0087>
    <DN0088>${benefits.DN0088 ?? ""}</DN0088>
    <DN0089>${benefits.DN0089 ?? ""}</DN0089>
    <DN0090>${benefits.DN0090 ?? ""}</DN0090>
    <DN0091>${benefits.DN0091 ?? ""}</DN0091>
    <DN0174>${benefits.DN0174 ?? ""}</DN0174>
    <DN0175>${benefits.DN0175 ?? ""}</DN0175>
    <DN0192>${benefits.DN0192 ?? ""}</DN0192>
    <DN0211>${benefits.DN0211 ?? ""}</DN0211>
  </Benefits>`.trim()).join('\n');
...
<Claims>
  ...
  <Main>
    ...
    ${paymentsXml}
    <!-- <Payments_loop> -->
    <!-- <DN0195>20240529</DN0195> -->
    <!-- <DN0217>Barnum Clinton</DN0217> -->
    <!-- <DN0218>250.00</DN0218> -->
    <!-- <DN0219>20240529</DN0219> -->
    <!-- <DN0220>20240529</DN0220> -->
    <!-- <DN0222>500</DN0222> -->
    <!-- </Payments_loop> -->
    <!-- <Payments_loop> -->
